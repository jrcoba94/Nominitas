<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/NominasMP.Master" AutoEventWireup="true" CodeBehind="AgregarEmpleado.aspx.cs" Inherits="Nomina2018.GUI.AgregarEmpleado" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="card card-body text-left">
        ...
        <div class="form-row">
            ...
            <div class="col-md-4 mb-3">
                ...
                <asp:TextBox ID="txtFechaNacimiento" type="date" runat="server" class="form-control" required="required"></asp:TextBox>
            </div>
            <div class="col-md-4 mb-3">
    ...
    <div class="card card-footer">
        <div class="col-12 text-right">
            <a class="btn btn-secondary btn-sm m-2" href="Empleados.aspx">Cancelar</a>
